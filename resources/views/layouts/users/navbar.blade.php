                    ...
                    <div class="header__main-content-wrapper p-relative">
                        <div class="header__main-left">
                            <div class="header__logo">
                                <a href="" class="logo-dark"><img src="{{ asset('assets/img/logo/pralon.png') }}" alt="logo-img"></a>
                            </div>
                        ...
                        <div class="header__main-right">
                            ...
                            <div class="purchase__now d-none d-sm-inline-flex">
                                <div class="meta-item">
                                    <a href="https://themeforest.net/item/dofix-plumbing-repair-store-html5-template/48035083" target="_blank" class="primary-btn hover-white">Purchase Now
